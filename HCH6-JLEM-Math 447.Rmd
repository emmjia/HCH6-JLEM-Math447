...
cutting.speed = data.frame(factorA, factorB, factorC, Rep, yield)

#Treatment.Comination=c("(1)","a","b","ab","c","ac","bc","abc")
#rep1 = c(22,32,35,55,44,40,60,39)
#rep2 = c(31,43,34,47,45,37,50,41)
#rep3 = c(25,29,50,46,38,36,54,47)

#cutting.speed = data.frame(factorA,factorB,factorC,Treatment.Comination,rep1,rep2,rep3)
```
